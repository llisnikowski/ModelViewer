...
if(NOT CLANG_FORMAT)
    ...
    message(STATUS "clang-format was found, 'clang-format-fix' and 'clang-format-check' targets can be used")

    add_custom_target(clang-format-fix COMMAND ${CLANG_FORMAT}
        --style=file
        -i
        ${ALL_FILES}
